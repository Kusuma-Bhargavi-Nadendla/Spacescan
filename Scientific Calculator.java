...
class Calculators {
	...
	private void initialize() {
		...
		CalculatorFrame.getContentPane().setBackground(new Color(0,0, 255));
		CalculatorFrame.getContentPane().setFont(new Font("Calibri", Font.PLAIN, 15));
                CalculatorFrame.getContentPane().setForeground(new Color(123,23,250));
		...
		//textPanel.setBounds(34, 25, 316, 80);
                textPanel.setBounds(20, 10, 350, 100);
		...
		//button1.setFont(new Font("Calibri Light", Font.PLAIN, 17));
                button1.setFont(new Font("Teal", Font.PLAIN, 17));
		...
		//button2.setFont(new Font("Calibri Light", Font.PLAIN, 14));
                button2.setFont(new Font("Teal", Font.PLAIN, 13));
		...
		CalculatorFrame.setBounds(200, 100, 400, 500);
